...
urlpatterns = [
    ...
    path("seatplan/subjects/", views.SeatplanSubjectListView.as_view(), name="seatplan_subjects"),
    path("seatplan/students/", views.SeatplanStudentsView.as_view(), name="seatplan_students"),

     path("seatplan/preview/", views.SeatplanPreviewView.as_view(), name="seatplan_preview"),
    path("seatplan/preview/<str:mode>/", views.SeatplanPreviewView.as_view(), name="seatplan_preview_mode"),
